...
- **Q1 (يعيق إغلاق C2):** وجهة النسخ الاحتياطي الخارجي المشفر (S3-متوافق مثل Backblaze B2؟ سيرفر آخر عبر SSH؟) — البنية ستُجهز بـrestic والوجهة قرارك.
- **Q2 (قبل C5):** الحد الأدنى للراتب في الإعداد: إلزامي أم اختياري (تخطّيه = بلا فلتر راتب، وتبقى سياسة «بلا راتب معلن» خيارًا مستقلًا)؟
- **Q3 (قبل C7):** تأكيد صيغة اسم الملف المُسلَّم: `FirstName LastName - Job Title.pdf` بالإنجليزية، وعند تصادم بنفس اليوم تُضاف الشركة؟
