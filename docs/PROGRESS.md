...
**التالي في C5:** C5.4 محادثة جمع البيانات → C5.5 خط رفع الملفات الآمن → C5.6 استخراج Claude (👤 يحتاج `ANTHROPIC_API_KEY` عند بدئه) → C5.7 تأكيد الحقائق → C5.8 تقييم المسار → C5.9 سياسة البحث/ACTIVE → C5.10 أوامر الخصوصية.
