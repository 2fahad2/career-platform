...
- **Q1 (يعيق إغلاق C2):** وجهة النسخ الاحتياطي — **اقتراح مفصل قُدِّم لفهد 14 يوليو** (التوصية: Backblaze B2 + restic؛ البديل: Hetzner Storage Box BX11). بانتظار اعتماده وإنشاء الحساب.
