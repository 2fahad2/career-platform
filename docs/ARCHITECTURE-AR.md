...
<tr><td><code dir="ltr">enrichment.py</code></td><td>🪄 إثراء الأدوار المختصرة: كشف الدور الشحيح، النداء اللطيف بالعامية مرة-للأبد، أزرار التخطي والتأكيد، المكنسة الساعية (نداء اليوم الثالث + إغلاق 72 ساعة).</td></tr>
<tr><td><code dir="ltr">achievement_render.py</code></td><td>🛡️ صياغة إجابة العامي سطرًا إنجليزيًا مع الحارس الحتمي العابر للغتين: كل رقم وأداة في الإنجليزية لازم توجد في العربية الأصلية — صفر اختراع؛ + كاتب أمثلة كاسر التجمّد ببوابة تنقية.</td></tr>
</table>
...
<tr><td><code dir="ltr">close.py</code></td><td>سلطة الحالات الثماني اليومية وإغلاق اليوم والملخص الإداري وتجميع التكاليف.</td></tr>
...
<tr><td><code dir="ltr">0014</code></td><td>مؤشر بوت الإدارة (صف نظامي واحد).</td></tr>
<tr><td><code dir="ltr">0015</code></td><td>منحة حذف جلسات القمع (محو الخصوصية).</td></tr>
<tr><td><code dir="ltr">0016</code></td><td>هاتف الطلب على الاشتراك — التفعيل بلا لمس.</td></tr>
<tr><td><code dir="ltr">0017</code></td><td>🆕 دفتر إثراء الأدوار المختصرة (مرة واحدة للأبد).</td></tr>
<tr><td><code dir="ltr">0018</code></td><td>FORCE RLS على outbox_events (صيد الاختبار الفوقي).</td></tr>
...
الويبهوك، ملفات هجوم الرفع، ربط السيرة والحجر، مصفوفة الحالات الثماني،
